package com.jayplabs.fibonacciclient;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        type = (RadioGroup) super.findViewById(R.id.type);
    ...
    protected void onResume() {
        ...
        Intent serviceIntent = new Intent(IFibonacciService.class.getName());
        serviceIntent.setPackage("com.jayplabs.fibonacciservice");
        if (!super.bindService(serviceIntent,
    ...
    ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            Log.d(TAG, "onServiceConnected()'ed to " + componentName);
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            Log.d(TAG, "onServiceDisconnected()'ed to " + componentName);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    FibonacciResponse response = service
                            .fib(request);
                    totalTime = SystemClock.uptimeMillis() - totalTime;
                    // generate the result
                    return String.format(
                            "fibonacci(%d)=%d\nin %d ms\n(+ %d ms)", n,
                            response.getResult(), response.getTimeInMills(),
                            totalTime - response.getTimeInMills());
